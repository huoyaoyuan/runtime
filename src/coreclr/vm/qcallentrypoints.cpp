...
static const Entry s_QCall[] =
{
    ...
    DllImportEntry(MarshalNative_MarshalVariantArrayObjectToOle)
    DllImportEntry(MarshalNative_MarshalSafeArrayForArrayRef)
    DllImportEntry(MarshalNative_MarshalOleRefVariantForObject)
